...
| 15b | **The block under the photo — the only body text allowed** | Not a decorative caption: it explains **WHY the hero commodity moved**, as **2 to 4 short lines** of very small Devanagari under the picture, each line ~6–9 words. **Every line must be lifted from that day's VK paper — real reported fact, never invented, never generic.** Order them cause first, consequence last. Worked example for a sugar crash: `केंद्र ने अगस्त का 22.50 लाख टन कोटा जारी किया` / `मिलों को पूरी बिक्री और उठाव अनिवार्य` / `न बेचने पर सख्त कार्रवाई की चेतावनी` / `दिल्ली में खुदरा भाव 68 से घटकर 62 रुपये`. **Shrink the photo to make room** — at 3–4 lines it should be about a third of the column height. Do not repeat a number the headline or hero line already shows. If the paper supports only two honest lines, use two — never pad to four |
